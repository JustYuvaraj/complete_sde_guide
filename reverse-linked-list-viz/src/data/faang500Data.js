        ...
        subtopics: [
            {
                ...
                problems: [
                    ...
                    { name: "Valid Anagram", lc: "242", diff: "🟢" },
                    { name: "Two Sum", lc: "1", diff: "🟢", component: "EngTwoSum" },
                    { name: "Group Anagrams", lc: "49", diff: "🟡" },
                    { name: "Top K Frequent Elements", lc: "347", diff: "🟡" },
                    { name: "Verifying an Alien Dictionary", lc: "953", diff: "🟡" },
                    { name: "Logger Rate Limiter", lc: "359", diff: "🟢" },
                    { name: "Ransom Note", lc: "383", diff: "🟢" },
                    { name: "Isomorphic Strings", lc: "205", diff: "🟢" },
                    { name: "Word Pattern", lc: "290", diff: "🟢" },
                    { name: "Subarray Sum Equals K", lc: "560", diff: "🟡" },
                ],
            },
            {
                ...
                problems: [
                    ...
                    { name: "Zigzag Conversion", lc: "6", diff: "🟡" },
                    { name: "Find the Index of First Occurrence", lc: "28", diff: "🟢" },
                    { name: "String to Integer (atoi)", lc: "8", diff: "🟡" },
                    { name: "Count and Say", lc: "38", diff: "🟡" },
                    { name: "Compare Version Numbers", lc: "165", diff: "🟡" },
                    { name: "Z Function", lc: "GFG", diff: "🟡", link: "https://www.geeksforgeeks.org/z-algorithm-linear-time-pattern-searching-algorithm/" },
                ],
            },
            {
                name: "Array Techniques",
                problems: [
                    { name: "Product of Array Except Self", lc: "238", diff: "🟡" },
                    { name: "Valid Sudoku", lc: "36", diff: "🟡" },
                    { name: "Encode and Decode Strings", lc: "271", diff: "🟡" },
                    { name: "Longest Consecutive Sequence", lc: "128", diff: "🟡" },
                    { name: "Next Permutation", lc: "31", diff: "🟡" },
                    { name: "First Missing Positive", lc: "41", diff: "🔴" },
                    { name: "Pascal's Triangle", lc: "118", diff: "🟢" },
                    { name: "Majority Element", lc: "169", diff: "🟢" },
                    { name: "Largest Number", lc: "179", diff: "🟡" },
                    { name: "Insert Delete GetRandom O(1)", lc: "380", diff: "🟡" },
                    { name: "Game of Life", lc: "289", diff: "🟡" },
                    { name: "Rotate Array", lc: "189", diff: "🟡" },
                    { name: "H-Index", lc: "274", diff: "🟡" },
                    { name: "Majority Element II", lc: "229", diff: "🟡" },
                    { name: "Reverse Pairs", lc: "493", diff: "🔴" },
                    { name: "Max Consecutive Ones", lc: "485", diff: "🟢" },
                    { name: "Move Zeroes", lc: "283", diff: "🟢", component: "EngMoveZeroes" },
                    { name: "Diagonal Traverse", lc: "498", diff: "🟡" },
                    { name: "Increasing Triplet Subsequence", lc: "334", diff: "🟡" },
                    { name: "Longest Mountain in Array", lc: "845", diff: "🟡" },
                    { name: "Max Points You Can Obtain from Cards", lc: "1423", diff: "🟡" },
        ...
        subtopics: [
            {
                ...
                problems: [
                    ...
                    { name: "Two Sum II Input Array Is Sorted", lc: "167", diff: "🟡" },
                    ...
                    { name: "Merge Sorted Array", lc: "88", diff: "🟢" },
                    { name: "Sort Colors", lc: "75", diff: "🟡" },
                    { name: "4Sum", lc: "18", diff: "🟡" },
                    { name: "3Sum Closest", lc: "16", diff: "🟡" },
        ...
        subtopics: [
            {
                ...
                problems: [
                    ...
                    { name: "Moving Average from Data Stream", lc: "346", diff: "🟢" },
            ...
            },
            {
                ...
                problems: [
                    ...
                    { name: "Distinct Numbers in Each Subarray", lc: "GFG", diff: "🟡", link: "https://www.geeksforgeeks.org/count-distinct-elements-in-every-window-of-size-k/" },
                ],
            },
        ],
    },
